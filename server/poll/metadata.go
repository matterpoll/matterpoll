...
type Metadata struct {
	...
	CanManagePoll          bool     `json:"can_manage_poll"` // CanManagePoll will be true if the user with "UserID" has admin permission for the poll with "PollID", otherwise false.
