...
// 			ExpectedText:         "",
// 			ExpectedAttachments:  testutils.GetPollTwoOptions().ToPostActions(testutils.GetSiteURL(), PluginId, "John Doe", converter),
// 		},
// 		"With 4 arguments": {
// 			SetupAPI: func(api *plugintest.API) *plugintest.API {
// 				api.On("GetUser", "userID1").Return(&model.User{FirstName: "John", LastName: "Doe"}, nil)
...
// 			ExpectedResponseType: model.COMMAND_RESPONSE_TYPE_IN_CHANNEL,
// 			ExpectedText:         "",
// 			ExpectedAttachments:  testutils.GetPoll().ToPostActions(testutils.GetSiteURL(), PluginId, "John Doe", converter),
// 		},
...
// 			ExpectedResponseType: model.COMMAND_RESPONSE_TYPE_IN_CHANNEL,
// 			ExpectedAttachments:  testutils.GetPollWithSettings(poll.PollSettings{Progress: true}).ToPostActions(testutils.GetSiteURL(), PluginId, "John Doe", converter),
// 		},
...
// 			ExpectedResponseType: model.COMMAND_RESPONSE_TYPE_IN_CHANNEL,
// 			ExpectedText:         "",
// 			ExpectedAttachments:  testutils.GetPollWithSettings(poll.PollSettings{Progress: true, Anonymous: true}).ToPostActions(testutils.GetSiteURL(), PluginId, "John Doe", converter),
// 		},
// 		"Store.Save fails": {
// 			SetupAPI: func(api *plugintest.API) *plugintest.API {
